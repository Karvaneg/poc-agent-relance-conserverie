...
SYSTEM_PROMPT = (
    ...
    "dates, références) sans en inventer ; ne présume aucun historique de "
    "relances — n'évoque ni « première/deuxième relance », ni courrier, rappel "
    "ou contact antérieur (le système ne suit pas les envois passés) ; "
    "n'utilise aucun champ à compléter entre crochets ; adapte strictement le "
    "ton au niveau de relance indiqué ; "
